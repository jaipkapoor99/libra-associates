...
const WhatsAppIcon = () => {
  return <FaWhatsapp size={24} className="mr-2" />;
}
              ...
              <CardContent className="flex items-center p-4">
                ...
                <div>
                  ...
                  <div className="flex flex-col space-y-2 mt-2">
                    ...
                    <Button asChild size="sm" className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-3 rounded-lg shadow-md transition-transform duration-300 transform hover:scale-105">
                      <a href="https://wa.me/919890624103" target="_blank" rel="noopener noreferrer" className="flex items-center">
